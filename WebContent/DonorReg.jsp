...
<%
    ...
    String did ="D_"+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10)
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class=" bounceInDown">Donor Registration Screen</h5>
                        <form action='DonorRegAction.jsp' method='post'>
                <table align="center" cellpadding="5px"style="margin-left: 35%;">
                    <tr><th>User Id</th><td><input type='text' name='did' value="<%=did%>"></td><tr/>
                   ...
                   <tr><th>Gender</th><td><select name="gender">
                    ...
                    <td><a href='Donor.jsp'>Login</a></td><tr/>
                </table>
            </form>     
