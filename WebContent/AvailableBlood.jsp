        ...
        <div class="container">
           ...
           <% String username=(String)session.getAttribute("username");
                    ...
                    <center>
                       ...
                       <%
                       try{
                           ResultSet r=Queries.getExecuteQuery("select * from profile where donated='waiting'");
                           while(r.next()){
                               %>
                               <tr>
                                   
                                   <td><%=r.getString(2)%></td>
                                   <td><font color="red"><%=r.getString(3)%></font></td>
                                   <td><%=r.getString(7)%></td>
                                   <td><a href="Request.jsp?pid=<%=pid%>&pname=<%=username%>&did=<%=r.getString(1)%>&bgroup=<%=r.getString("bloodgroup")%>&bname=<%=r.getString(7)%>">Send</td>
                               </tr>
                               <%
                           }
                       }catch(Exception e){
