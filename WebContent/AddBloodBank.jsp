...
<body>
    ...
    String did ="BB_"+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10)
            ...
            %>
                    ...
                    <center>
                    <form action="BBAction.jsp" method="post">
                        <table>
                            <tr><th>Blood Bank ID</th><td><input type="text" name="bbid" value="<%=did%>" readonly=""></td></tr>
                            <tr><th>Blood Bank Name</th><td><input type="text" name="name" required=""></td></tr>
